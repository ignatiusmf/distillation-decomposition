...
| [9] | Generate weekly progress summary | Not started | [thesis.md](thesis.md) |
...
- **[infrastructure.md](infrastructure.md)** — PBS job management, cron automation, post-deployment fixes ([1], [2], [3], [10])
- **[training.md](training.md)** — Training speed, plotting, distillation bug fixes ([4], [5], [11])
